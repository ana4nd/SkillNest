export default function Testimonials() {
    return (
        <div className="max-w-6xl mx-auto flex gap-10 flex-col ">
            <h1 className="text-center text-3xl font-semibold">Some of our Learners</h1>
        
            <div className="flex flex-wrap items-center justify-center sm:gap-28 md:gap-20 gap-10 pt-14">
