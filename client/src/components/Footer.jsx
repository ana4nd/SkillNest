...
export default function Footer() {
    return (
        <>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full mt-20 text-sm text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <img className="w-40 h-20 object-cover" src={assets.logo} alt="" />
                        <p className="text-sm/7 mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident impedit vel exercitationem dolores id qui et deserunt dolorem maxime, sequi quam aliquid autem corrupti aspernatur ipsum natus officiis tenetur molestiae!</p>
                    </div>
